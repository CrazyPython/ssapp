    ...
    <div class="row full-width">
      ...
      <div class="col" v-on:mouseout="iFrameMouseOut2" v-on:mouseover="aM">
        ...
        <div class="row" style="position: relative;">
          ...
          <div class="col value">
            <p class="compact">Stocks: <span class="pad">{{ formatPricePadding(portfolioTotal - referralTotal) }}</span>
            </p>
          ...
          <div class="col dollars">
            <p class="compact">Total: <span class="pad"
                                            id="totalvalue">{{ formatPricePadding(portfolioTotal + cashTotal - referralTotal)
              }}</span></p>

            <p class="compact">ROI $: <span
              class="pad">{{ formatPricePadding(portfolioTotal + cashTotal - 50000 - referralTotal) }}</span></p>
            <p class="compact">ROI %: <span class="pad"
                                            style="padding-right: 1.5em;">{{ formatPricePadding3((1 - this.roi) * 100)
              }}</span></p>
          </div>
...
">All numbers are after referrals, excluding cash, are subtracted.<br/>
      ...
      <a href="https://crazypython.github.io/stckstrm-static/shhh.html"><img height="15px"
